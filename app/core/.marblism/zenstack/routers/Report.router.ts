...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ReportInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).report.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ReportInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).report.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ReportInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).report.findFirst(input as any))),

        findMany: procedure.input($Schema.ReportInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).report.findMany(input as any))),
        ...
        count: procedure.input($Schema.ReportInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).report.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.ReportCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.ReportCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.ReportCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.ReportCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.ReportCountArgs>, 'cursor'>,
